...
const accountMenuFor = (me: Me | null): Tab[] => [
  // ตารางงาน ยังไม่เปิดให้พนักงานใช้ (แพรสั่ง 2026-07-31 — รอสร้างบัญชี/ลงทะเบียนใบหน้าก่อน)
  // แอดมินเห็นตลอดเพื่อทดสอบ · เปิดให้พนักงานได้ที่หน้า "ตั้งค่าระบบ" ไม่ต้อง deploy ใหม่
  // ลงเวลาเข้า-ออกงาน — เอาออกจากเมนูก่อน (แพรสั่ง 2026-08-04) ไม่โชว์แม้แต่แอดมิน
