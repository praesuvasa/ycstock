...
const USER_PAGES = ["/", "/store", "/yogi", "/stock", "/stock-in", "/sales", "/cash-remittance", "/requisitions", "/confirm-receipt", "/returns", "/expiry", "/allowance", "/set-pin", "/feedback", "/time-clock"];
// /set-pin ต้องเข้าได้ทุก role — ทุกคนต้องเปลี่ยนรหัสตัวเองได้ ไม่งั้นเมนูมีแต่กดแล้วเด้งกลับ
const RESTOCK_PAGES = ["/restock", "/store", "/yogi", "/requisitions", "/set-pin", "/feedback", "/time-clock"];
