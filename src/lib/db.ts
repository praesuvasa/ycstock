...
export const db = {
  ...
  clearFaceEnrollment: (userId: string): Promise<string | null> =>
    useSupabase ? supabaseStore.clearFaceEnrollment(userId) : Promise.resolve(memoryStore.clearFaceEnrollment(userId)),
