...
- **วันหยุดไทยที่ไม่อยู่ในรายการบริษัท** สินธรก็ยังเป็นกะครึ่งวัน (เข้าคนเดียวได้)
  ระบบจึงแยกเป็น 2 ชนิด: `company` = ได้วันหยุดเพิ่มในเดือนนั้น · `thai` = ไม่ได้วันหยุดเพิ่ม แต่ SND เปิดครึ่งวัน
