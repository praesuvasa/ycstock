...
("it-018","Drink/Yogurt Pouch","Peanut Butter","กระปุก",None,None,None),
("it-019","Drink/Yogurt Pouch","Water น้ำดื่ม","ขวด",12,12,None),
("it-020","Drink/Yogurt Pouch","ถุงสตรอเบอรี่","ถุง",12,8,5),
("it-021","Drink/Yogurt Pouch","ถุงบลูเบอรี่","ถุง",12,8,5),
("it-022","Drink/Yogurt Pouch","ถุงธรรมชาติ","ถุง",12,10,5),
("it-023","Drink/Yogurt Pouch","ถุงลิ้นจี่","ถุง",12,8,5),
("it-024","Drink/Yogurt Pouch","ถุงยูส","ถุง",12,8,5),
("it-025","Drink/Yogurt Pouch","ถุงพีช","ถุง",8,5,5),
